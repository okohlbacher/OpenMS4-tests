...
- Each package is an independent private Git submodule. Commit a changed dependency first, then update consumer dependency locks, then the parent gitlink and packages.lock.json.
