...
The [standalone TOPP SDK build](docs/topp-sdk-validation.md) validates the current TOPP pin with the original repositories and build trees inaccessible: 130 tools, 258 metadata tests and 338 installed numerical/negative tests passed. The subsequent [complete runnable TOPP test and runtime report](docs/topp-runtime-report.md) records 1,948 checks passed, five skipped and zero failures in 342.03 seconds, plus repeated TICCalculator reading benchmarks.
