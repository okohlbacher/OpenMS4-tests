...
All repositories are private and GitHub Actions are disabled. No OpenMS/native product compilation was performed during extraction. Source/configuration checks cannot establish ABI, numerical behavior, wheel repair or desktop deployment. Run the ordered acceptance gates in the plan before treating any package as releasable. The artifact verifier intentionally rejects placeholder hashes; no binary artifacts have been fabricated.
